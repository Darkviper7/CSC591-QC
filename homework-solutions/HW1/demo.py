...
def factor(P):
    ...
    for sample, num_occurrences, energy in sampleset.data(['sample', 'num_occurrences','energy']):
...
def display_output(output):
    header1_str = 'Factors    Valid?  Energy  Percentage of Occurrences'
    ...
    for result in output['Results']:
        ...
        # print(energy)
        print('({:3},{:3})  {:3}      {:3}      {:3.0f} '.format(result['a'], result['b'], 'Yes' if result['Valid'] else '', energy, percentage), end='')
